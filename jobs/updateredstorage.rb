...
SCHEDULER.every '10m', :first_in => 0 do |job|
  ...
  #  i += 1
  #end
  capacity = `wget -qO- http://t2.unl.edu:8088/dfshealth.jsp | grep Configured | cut -d ' ' -f 10`.to_f * 1024
  used = `wget -qO- http://t2.unl.edu:8088/dfshealth.jsp | grep Configured | cut -d ' ' -f 20`.to_f * 1024
